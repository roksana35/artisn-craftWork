...
const Navbar = () => {
  ...
  const [theme,setThemes]=useState(localStorage.getItem('theme')||'light')
  useEffect(()=>{
  ...
  <svg className="col-start-2 row-start-1 stroke-base-100 fill-base-100" xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21 12.79A9 9 0 1 1 11.21 3 7 7 0 0 0 21 12.79z"></path></svg>
</label>
    {
      ...
      <button onClick={handleLogout} className="btn bg-green-500 text-white">LogOut</button> 
        ...
        <Link to='/login' className="lg:mr-3 btn text-black bg-green-500">Login</Link>
      <Link to='/register' className=" btn text-black bg-green-500">Register</Link>
      </div>
    }
